...
def create_initial_variants():
    ...
    try:
        ...
        variants_data = [
            ...
            {"product_id": 1, "color": "화이트", "size": "S", "stock_quantity": 20},
            {"product_id": 1, "color": "화이트", "size": "M", "stock_quantity": 25},
            {"product_id": 1, "color": "화이트", "size": "L", "stock_quantity": 20},
            {"product_id": 1, "color": "블랙", "size": "S", "stock_quantity": 15},
            {"product_id": 1, "color": "블랙", "size": "M", "stock_quantity": 20},

            # 프리미엄 오가닉 티셔츠 (product_id: 2)
            {"product_id": 2, "color": "네이비", "size": "S", "stock_quantity": 10},
            {"product_id": 2, "color": "네이비", "size": "M", "stock_quantity": 15},
            {"product_id": 2, "color": "네이비", "size": "L", "stock_quantity": 10},
            {"product_id": 2, "color": "그레이", "size": "M", "stock_quantity": 15},

            # 클래식 스트레이트 청바지 (product_id: 3)
            {"product_id": 3, "color": "블루", "size": "28", "stock_quantity": 15},
            {"product_id": 3, "color": "블루", "size": "30", "stock_quantity": 20},
            {"product_id": 3, "color": "블루", "size": "32", "stock_quantity": 20},
            {"product_id": 3, "color": "블루", "size": "34", "stock_quantity": 20},

            # 슬림핏 청바지 (product_id: 4)
            {"product_id": 4, "color": "다크블루", "size": "28", "stock_quantity": 12},
            {"product_id": 4, "color": "다크블루", "size": "30", "stock_quantity": 18},
            {"product_id": 4, "color": "다크블루", "size": "32", "stock_quantity": 18},
            {"product_id": 4, "color": "블랙", "size": "30", "stock_quantity": 12},

            # 데님 재킷 (product_id: 5)
            {"product_id": 5, "color": "라이트블루", "size": "S", "stock_quantity": 8},
            {"product_id": 5, "color": "라이트블루", "size": "M", "stock_quantity": 12},
            {"product_id": 5, "color": "라이트블루", "size": "L", "stock_quantity": 10},
        ]
        ...
        for variant in created_variants:
            logger.info(
                f"  {variant.variant_id}: 상품 {variant.product_id} - {variant.color}/{variant.size} (재고: {variant.stock_quantity}개)"
            )
